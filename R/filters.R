...
GTfilter <- function(obj, n, geno, remove=F) {
...
# @param obj vcf object
# @return filtered vcf object
GTdiffFilter <- function(obj) {
  mat <- SampleMerge(obj, 2, 1)
...
# @param obj vcf object
# @return filtered vcf object
DPfilter <- function(obj, n, depth, depthv=F) {
...
# @param obj vcf object
# @return filtered vcf object
homFilter <- function(obj, n, perc=95) {
  ...
  pervar <- as.numeric(as.character(depths[,"DV"]))/as.numeric(as.character(depths[,"DP"]))*100
