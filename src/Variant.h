...
class Variant
{
 ...
 public:
  ...
  Variant(const std::string& line, char& strand)
  {
    ...
    this->pos = atol(attr_set[1].c_str());
    this->ref = attr_set[3];
    this->alt = attr_set[4];
    this->qual = atol(attr_set[5].c_str());
    ...
    this->dna_dp = atof(dna_call[2].c_str());
    this->dna_dv = atof(dna_call[3].c_str());
    ...
    this->rna_dp = atof(rna_call[2].c_str());
    this->rna_dv = atof(rna_call[3].c_str());
  }
